<div class=" bg-white md:pt-4 md:pb-8">
    ...
    <textarea id="myTextarea" class="textarea textareaMobile animation-fav resize-none w-full h-48 md:h-64 lg:h-72 xl:h-80 border border-gray-300 rounded p-4 focus:outline-none focus:border-blue-500">¿Quieres invertir en un nuevo negocio y necesitas asesoramiento profesional? 🫵✌️👍😉
...
#asesoria #despacho #administracion #gestoría #legal #trámites #freelance #business #autonomo #escritorio #negocios #asesoría #lawyer #arquitectura #marketing #lawfirm #emprender #empresas #autónomos #tugestoria #tuasesoriadeconfianza #confianza #profesionales
        ...
        <div class="absolute bottom-2 left-2 text-grayPrimary mt-3 ml-4 flex items-center">
