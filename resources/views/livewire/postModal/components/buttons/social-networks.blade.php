<div class="grid grid-cols-2 md:flex flex-wrap justify-start items-start max-w-full">
        @foreach($buttons as $index => $button)
            <button
                ...
                class="flex items-start backgroundButton fontSocial md:px-2 md:py-1 mx-2.5 my-1.5 rounded transition-opacity duration-300 {{ $clickedButtonIndex === $index ? 'opacity-50' : '' }} focus:outline-none"
            >
