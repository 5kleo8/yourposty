<div class="flex flex-col items-center sm:flex-row justify-end">
        <button
            wire:click="nextStep"
            class="w-36 bg-blackPrimary text-white  py-3 px-4 rounded mb-2 sm:mb-0 sm:mr-4 flex items-center justify-center cursor-not-allowed opacity-20">
            <p class="buttonDesktop buttonMobile">Siguiente</p>
        </button>

    <button
        wire:click="prevStep"
        class="w-36 bg-white text-blackPrimary  py-3 px-4 rounded mb-2 sm:mb-0 sm:mr-4 sm:order-first flex items-center justify-center">
        ...
        <button
            wire:click="prevStep"
            class="w-36 bg-white text-blackPrimary border border-blackPrimary hover:border-bluePrimary  py-3 px-4 rounded mb-2 sm:mb-0 sm:mr-4 sm:order-first flex items-center justify-center">
