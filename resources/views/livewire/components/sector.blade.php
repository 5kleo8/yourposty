<div class="px-16">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-3">
        ...
        >
            ...
            <p class=" font-normal hidden md:block text-grayPrimary ">
        ...
        <button
            ...
            wire:click="selectOption"
        >
            <img src="{{ asset('img/Perfil-11.svg') }}" class="md:w-12 md:h-12 h-7 w-7 mx-auto mt-px">
    ...
    <div class="mt-6">
        <livewire:text-input
            class="border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-bluePrimary resize"
            label=""
            :placeholder="'Otro'"
            :maxInputLength="50"
