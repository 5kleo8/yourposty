<div class="px-4">
    <h2 class="md:text-2xl text-1xl md:mb-6 mb-2 text-center">¿A qué sector pertenece tu empresa?</h2>
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <button
            ...
            wire:click="selectOption"
        >
            <img src="{{ asset('img/Perfil-11.svg') }}" class="mt-1 mx-auto">
        ...
        <button
            ...
            wire:click="selectOption"
        >
            <img src="{{ asset('img/Perfil-12.svg') }}" class="mt-1 mx-auto">
            <p class="text-center font-normal">
        ...
        <button
            ...
            wire:click="selectOption"
        >
            <img src="{{ asset('img/Perfil-14.svg') }}" class="mt-1 mx-auto">
            <p class="text-center font-normal">
                Ocio y turismo
            </p>
            <p class="text-sm font-normal hidden md:block text-grayPrimary">
        ...
        <button
            ...
            wire:click="selectOption"
        >
            <img src="{{ asset('img/Perfil-13.svg') }}" class="mt-1 mx-auto">
            <p class="text-center font-normal">
        ...
        <button
            ...
            wire:click="selectOption"
        >
            <img src="{{ asset('img/Perfil-15.svg') }}" class="mt-1 mx-auto">
            <p class="text-center font-normal ">
    ...
    <div class="mt-6">
        <livewire:text-input
            class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-bluePrimary resize"
            label=""
            :placeholder="'Otro'"
            :maxInputLength="50"
